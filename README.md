...
https://upcloud.com/docs/guides/initialization-scripts/

## List of available init scripts
Below is a lst of scripts that can be used to automatically deploy apps on new UpCloud servers.
- [Wordpress](wordpress)
- [Beszel](beszel)
